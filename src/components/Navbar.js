            ...
            <div className="flex h-screen dark:bg-slate-900 fixed z-[999]">
                <div className="bg-slate-100 flex flex-col dark:bg-slate-800">
                    ...
                    <Link to="/" className="cursor-pointer my-4">
                        ...
                        <p className="w-full font-base text-center pt-2 text-sm text-slate-400" {...activeNavIcon('/')}>Home</p>
                    </Link>
                    ...
                    <Link to="/stats" className="cursor-pointer my-4">
                        ...
                        <p className="w-full font-base text-center pt-2 text-sm text-slate-400" {...activeNavIcon('/stats')}>Stats</p>
                    </Link>
                    ...
                    <Link to="/report" className="cursor-pointer my-4">
                        ...
                        <p className="w-full font-base text-center pt-2 text-sm text-slate-400" {...activeNavIcon('/report')}>Report</p>
                    </Link>
                    ...
                    <Link to="/about" className="cursor-pointer my-4">
                        ...
                        <p className="w-full font-base font-inter text-center pt-2 text-sm text-slate-400" {...activeNavIcon('/about')}>About</p>
                    </Link>

                    <div className="px-8 pb-12 cursor-pointer fixed bottom-0">
                        {colorTheme === "light" ?
